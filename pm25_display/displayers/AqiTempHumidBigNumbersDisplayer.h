#ifndef AqiTempHumidBigNumbersDisplayer_h
#define AqiTempHumidBigNumbersDisplayer_h
...
class AqiTempHumidBigNumbersDisplayer : public Displayer {
public:
  AqiTempHumidBigNumbersDisplayer(Adafruit_SSD1306 *display,
